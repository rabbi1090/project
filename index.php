        ...
        <div class="demo">
            <div class="login">
                <div class="login__check">
                    <img src="img/hellochat2.png" alt="user">
                </div>
                <div class="login__form">
                    <form method="POST">
                        <div class="login__row">
                            ...
                            <input type="text" name="username" class="login__input name"
                        ...
                        <div class="login__row">
                            ...
                            <input type="password" name="pass" class="login__input pass" value="<?php echo $pass; ?>"
